            ...
            <div class="card-body">
                <table class="table table-striped" id="table1">
                    ...
                    <tr>
                        ...
                        <td>
                           <a href="{{route('dusun.edit', $data->id)}}" class="btn btn-sm bg-warning mb-2">Edit</a>

                           
                           <form action="{{ route('dusun.destroy', $data->id) }}" method="post">
                            @csrf
                            @method('DELETE')
                                <button type="submit"  onclick="return confirm('apakah anda yakin ?')" class="btn btn-sm text-white bg-danger mb-2">Hapus</button>
                            </form>

                        <a href="{{route('dusun.show', $data->id)}}" class="btn btn-sm bg-warning mb-2">Lihat</a>
                        </td>
                    </tr>
